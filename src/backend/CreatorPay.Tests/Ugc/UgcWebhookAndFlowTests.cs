...
public class UgcWebhookAndFlowTests
{
    ...
    private sealed class World : IDisposable
    {
        ...
        public IUgcCampaignService CampaignService => new UgcCampaignService(R<UgcCampaign>(), R<UgcApplication>(), R<UgcCollab>(), R<BrandProfile>(), R<CreatorProfile>(), R<UgcCreatorProfile>(), Uow, Notifications, new UnconfiguredUgcBriefGenerator(), NullLogger<UgcCampaignService>.Instance, Settings);
