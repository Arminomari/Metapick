...
export interface ActionCounts { pendingApplications: number; pendingVideoReviews: number; awaitingYourVideo: number; pendingCommunityRequests: number; pendingTapReviews: number; unreadSupport: number }
